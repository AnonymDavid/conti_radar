...
const int FILTERCFG_INDEX = 8; // Multiplexor to specify which filter criterion to configure
...
// Index 8. Objects
const double FILTERCFG_MIN_PROBEXISTS = 2; // Probability of existence
